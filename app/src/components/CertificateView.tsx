...
export default function CertificateView({ onNavigate, testedInstallment, financials, loading }: CertificateViewProps) {
  ...
  // Mock certificate metadata
  const verificationId = 'QDH-2026-0182';
  const issueDate = '2026-07-16';
  const expiryDate = '2026-10-16';
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 text-xs">
              ...
              <div className="flex justify-between items-center border-b border-dashed border-slate-200 pb-2">
                ...
                <span className="font-extrabold font-mono text-brand-clay">{testedInstallment.toLocaleString()} ر.س</span>
              </div>
