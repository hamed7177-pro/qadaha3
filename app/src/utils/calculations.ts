...
export function analyzeFinancials(
  ...
  if (prediction === 'Suitable') {
    ...
    recommendations.push('خفّض مصاريف المطاعم والترفيه بنسبة 15% لتوفير فائض إضافي يعادل 740 ⃁ شهرياً.');
    recommendations.push('قم ببناء احتياطي مالي طوارئ بقيمة 5,000 ⃁ على الأقل في محفظتك الادخارية.');
    recommendations.push('ابحث عن إمكانية تعديل قسط الالتزام الجديد ليكون 900 ⃁ بدلاً من 1,200 ⃁ (تأجيل الالتزام لشهرين).');
  } else {
